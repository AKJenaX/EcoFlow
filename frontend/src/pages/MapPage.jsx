          ...
          <div className="space-y-3">
            ...
            <div className="border-t border-slate-200 pt-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-1 w-4 bg-yellow-500" />
                  <span className="text-xs text-slate-700">In Progress</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-1 w-4 border-2 border-slate-400" style={{ backgroundImage: "repeating-linear-gradient(90deg, #94a3b8 0px, #94a3b8 5px, transparent 5px, transparent 10px)" }} />
